...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // swyft: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Swyft can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
