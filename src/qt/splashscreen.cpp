    ...
    QWidget(0, f), curAlignment(0), m_node(node)
{
    ...
    QString titleText       = tr("Swyft Core");
    ...
    QString copyrightTextSwyft   = QChar(0xA9)+QString(" 2019-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Swyft Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+36, copyrightTextSwyft);
