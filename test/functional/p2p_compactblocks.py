...
# TestP2PConn: A peer we use to send messages to swyftd, and store responses.
...
class CompactBlocksTest(SwyftTestFramework):
    ...
    # This test actually causes swyftd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that swyftd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for swyftd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # swyftd will not send blocktxn responses for blocks whose height is
